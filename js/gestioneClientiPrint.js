...
console.log(result[i].id_cliente);
    ...
    data[5] = (result[i].indirizzo);
        ...
        let object = new String('cliente');
        aDelete.href = ('delete.php?id='+ result[i].id_cliente +'&object='+object);
        containerButton.appendChild(aDelete);
         ...
         a.textContent = 'Entra';
         a.href = ('cliente.php?id=' + result[i].id_cliente);
