...
<head>
    ...
    <script src="js/clienteValuePrint.js" defer="true"></script>
...
<div class="boardContainer">
  ...
  <div class="container-form">
      <form name='form'  method='post' action="">
          ...
          <h2>Modifica le Informazioni del Cliente</h2>
           </div>
          ...
          <input class="hidden" type="text" name="id"  > 
                  <div class="p-form">
                      <p>Nome</p> 
                      <input class="inputForm" type="text" name="nome" placeholder="" > 
                  </div>
                  <div class="p-form">
                      <p>Telefono</p> 
                      <input class="inputForm" type="phone" name="tel">
                  </div>
                  <div class="p-form">
                      <p>Email</p>
                  ...
                  <div class="rightSide">
                        <div class="p-form">
                            <p>Città</p> 
                            <input class="inputForm" type="text" name="citta" placeholder="">
                        </div>
                        <div class="p-form">
                            <p>Indirizzo</p> 
