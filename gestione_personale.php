...
<head>
    ...
    <script src="js/gestionePersonale.js" defer="true"></script>
  ...
  <div class="pageContainer">
      ...
      <div class="boardContainer">
        ...
        <div class="container-form">
            <form name='form'  method='post' action="php/queryGestionePersonaleInsert.php">
                <!--CAMPI DATI PAZIENTE-->
                ...
                <div class="form-patient">
                    <div class="leftSide">
                        ...
                        <div class="p-form">
                            ...
                            <input class="inputForm" type="text" name="citta_nascita" placeholder="Città"  >
                        </div>
                        <div class="p-form">
                            <p>Data di nascita</p>
                            <input id="inputFormData" type="date" value="" name="data_nascita" pattern="\d{4}-\d{2}-\{d2}" >    
                        </div>
                        <div class="p-form">
                            <p>Comune di residenza</p> 
                            <input class="inputForm" type="text" name="citta_residenza" placeholder="Comune di residenza"  > 
                        </div>
                    ...
                    <div class="p-form">
                            <p>Indirizzo</p> 
                            <input class="inputForm" type="text" name="indirizzo" placeholder="Via/N°" >
                        </div>
                    <div class="p-form">
                            <p>Email</p> 
                         ...
                         <div class="p-form">
                            <p>Nome utente</p> 
                            <input class="inputForm" type="text" name="user" placeholder="Nome utente" required > 
                        </div>
                         <div class="p-form">
                            <p>Password</p> 
                            <input class="inputForm" type="password" name="psw" placeholder="Password" required >
                        </div>
                        <div class="p-form">
                            <p>Conferma password</p> 
                            <input class="inputForm" type="password" name="conferma" placeholder="Conferma password" required >
                        </div>
